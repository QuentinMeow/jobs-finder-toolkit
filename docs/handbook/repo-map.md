...
| `automation/shared/metadata_editor.py` | **Canonical** formatting-preserving schema-v5 `meta.yaml` editor (YAML node anchors, checksums, atomic writes, semantic verification, idempotence). Vendored (consumers: `TARGETS`) |
