...
the writing rules in [docs/handbook/doc-style.md](../../handbook/doc-style.md): every section
...
- **Complements the token-usage-modes program** (`docs/designs/token-usage-modes/`):
