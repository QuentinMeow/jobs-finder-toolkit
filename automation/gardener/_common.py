...
already required by ``automation/shared/config.py`` and every skill). This module is
repo-root maintenance tooling, so — per AGENTS.md "Sharing Code Across Skills" — it
imports the canonical ``automation/shared/config.py`` directly to resolve overlay
