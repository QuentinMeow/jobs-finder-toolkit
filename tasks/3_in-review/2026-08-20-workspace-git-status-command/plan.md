# Plan — 2026-08-20-workspace-git-status-command

- [x] Define the read-only Git inventory and compact visual vocabulary.
- [x] Implement the repository-local command and its verbose mode.
