...
- **Area**: harness
- **Source**: docs/designs/tree-instructions/README.md (2026-07-21, respecced
...
- `_copy_tree` follows symlinks, so an exported `docs/designs/CLAUDE.md`
...
stable leaves (e.g. `docs/designs/` churns weekly by design while its style
leaf should not).
