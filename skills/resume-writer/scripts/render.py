...
Usage (accepts the app folder, or the source/tailored.yaml path):
    python skills/resume-writer/scripts/render.py applications/6_drafted/<slug>/
    python skills/resume-writer/scripts/render.py applications/6_drafted/<slug>/source/tailored.yaml
    python skills/resume-writer/scripts/render.py applications/6_drafted/<slug>/ --reference path/to/reference.docx
"""
...
def main():
    ...
    parser.add_argument("--skip-checks", action="store_true",
                        help="Skip post-render validation (skills/resume-writer/scripts/check.py)")
