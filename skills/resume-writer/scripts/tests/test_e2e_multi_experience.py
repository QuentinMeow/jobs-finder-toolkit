...
HANDOFF = REPO_ROOT / "skills" / "job-search" / "scripts" / "handoff.py"
RENDER = REPO_ROOT / "skills" / "resume-writer" / "scripts" / "render.py"
STATUS = (
    REPO_ROOT / "skills" / "application-tracker" / "scripts" / "status.py"
)
        ...
        self.config.write_text(
            yaml.safe_dump({
                ...
                "paths": {
                    ...
                    "reference_docx": str(
                        REPO_ROOT / "examples" / "me" / "career" / "resume"
