...
Usage:
    ...
    .venv/bin/python skills/application-tracker/scripts/filter_jobs.py --status applied,in_progress --sort date
    .venv/bin/python skills/application-tracker/scripts/filter_jobs.py --min-level 5.0 --workplace remote --json
    .venv/bin/python skills/application-tracker/scripts/filter_jobs.py --company stripe --min-salary 200000 --count
"""
