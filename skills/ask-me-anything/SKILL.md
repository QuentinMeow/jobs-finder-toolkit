...
and `docs/handbook/private-overlay.md` for the two-repo model. Never commit real identity to the public
...
- **"Where does my private data go?"** → the overlay / git-ignored paths; see `docs/handbook/private-overlay.md`.
